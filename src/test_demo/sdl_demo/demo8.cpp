...
int main(int argc, char* args[]) {
    ...
    /*
        ...
        判断是否成功创建 编译
    */
    Shader object_shader("Shaders/material_texture.vs", "Shaders/material_texture.fs");
    ...
    while (!quit_flag) {
        ...
        object_shader.setVec3("light.ambient", glm::vec3(0.2f, 0.2f, 0.2f));
        object_shader.setVec3("light.diffuse", glm::vec3(0.5f, 0.5f, 0.5f)); // 将光照调暗了一些以搭配场景
